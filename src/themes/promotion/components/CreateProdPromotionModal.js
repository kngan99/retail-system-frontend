...
const CollectionCreateForm = ({ visible, onCreate, onCancel, products }) => {
...
const CreateProdPromotionModal = (pros) => {
    ...
    const onCreate = async (values) => {
        console.log("Received values of form: ", values);
        await prodpromotionStore.createPromotion({ ...values, StartTime: new Date(values.ValidTime[0]), EndTime: new Date(values.ValidTime[1]) })
